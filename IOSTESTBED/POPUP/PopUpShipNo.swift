...
struct PopUpShipNo: View {
    @Binding var isShowingShipNo: Bool
    ...
    var body: some View {
        ...
        VStack (alignment:.leading,  spacing: 3)
        {
            ...
            HStack {
                ...
                Button(action: {
                    var textReult : String = loadData(from: selectedOption, to: textShip)
                   // textResult = "";
                    //isBigEngine = false
                }) {
                    Image("iconsearch")
...
struct PopUpShipNo_Previews: PreviewProvider {
    static var previews: some View {
        PopUpShipNo(isShowingShipNo: Binding.constant(false), state: Binding.constant(0), textInput: Binding.constant(""))
    }
}
